...
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (1, 'Matt', 'Matt', 'France', 'matt@gmail.com', '2020-04-23', 'https://robohash.org/numquamutut.png?size=150x150&set=set1', 1, '1k0k6MUzx8Pp0AekXjSLiikEUAo2');
insert into UserProfile (Id, DisplayName, FirstName, LastName, Email, CreateDateTime, ImageLocation, UserTypeId, FirebaseUserId) values (2, 'Ashley', 'Ashley', 'France', 'ashley@gmail.com', '2020-04-20', 'https://robohash.org/nisiautemet.png?size=150x150&set=set1', 2, 'X0t10vDX8JNjYxmZ09Tn4FXTl8n2');
